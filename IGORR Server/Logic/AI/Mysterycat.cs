...
namespace IGORR_Server.Logic.AI
{
    class Mysterycat : NPC
    {
        ...
        public override void Update(Map map, float seconds)
        {
            ...
            {
                IGORRProtocol.Messages.SetGlowMessage sgm = (IGORRProtocol.Messages.SetGlowMessage)IGORRProtocol.Protocol.NewMessage(IGORRProtocol.MessageTypes.SetGlow);
                sgm.id = _id;
                ...
                if (map.GetTrigger("MoveCat3"))
                {
                    ...
                    sgm = (IGORRProtocol.Messages.SetGlowMessage)IGORRProtocol.Protocol.NewMessage(IGORRProtocol.MessageTypes.SetGlow);
                    sgm.id = _id;
                    sgm.Position = MidPosition - Vector2.UnitY * 20;
