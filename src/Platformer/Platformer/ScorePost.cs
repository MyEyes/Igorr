...
namespace Platformer
{
    class ScorePost : EventObject
    {
        ...
        public ScorePost(Map map, Texture2D texture, Rectangle position, int id)
        ...
        public override void Update(float ms)
        {
            ...
            LightMap.LightReference.SetGlow(_id, new Vector2(Rect.X + 12, Rect.Y + 10), color == ScoreColor.Neutral ? Color.Gray : color == ScoreColor.Blue ? Color.Blue : Color.Red, radius, false);
        }
