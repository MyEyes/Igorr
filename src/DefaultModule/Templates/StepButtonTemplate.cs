...
{
    class StepButtonTemplate : IGORR.Modules.ObjectTemplate
    {
        ...
        {
            return new IGORR.Server.Logic.StepOnButton(bin.ReadString(), bin.ReadBoolean(), map, new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
        ...
        {
            return new IGORR.Client.Logic.StepButton(map, IGORR.Content.ContentInterface.LoadTexture("StepButton"), new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
