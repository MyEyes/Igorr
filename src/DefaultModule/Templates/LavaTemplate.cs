...
{
    class LavaTemplate : IGORR.Modules.ObjectTemplate
    {
        ...
        {
            return new IGORR.Server.Logic.Lava(map, new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
        ...
        {
            return new IGORR.Client.Logic.Lava(map, IGORR.Content.ContentInterface.LoadTexture("Lava"), new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
