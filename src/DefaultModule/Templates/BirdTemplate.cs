...
{
    class BirdTemplate:IGORR.Modules.ObjectTemplate
    {
        ...
        {
            return new IGORR.Client.Logic.Player("cbird", new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
