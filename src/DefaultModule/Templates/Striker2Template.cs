...
{
    class Striker2Template : IGORR.Modules.ObjectTemplate
    {
        ...
        {
            return new IGORR.Server.Logic.PartPickup(new IGORR.Server.Logic.Striker2(),map, new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID, true);
        }
