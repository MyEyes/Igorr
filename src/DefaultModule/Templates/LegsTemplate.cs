...
namespace DefaultModule.Templates
{
    class LegsTemplate : IGORR.Modules.ObjectTemplate
    {
        ...
        {
            return new IGORR.Client.Logic.PartPickup(new IGORR.Client.Logic.Legs(IGORR.Content.ContentInterface.LoadTexture("FeetIcon")),map, new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
