...
{
    class BlockerTemplate : IGORR.Modules.ObjectTemplate
    {
        ...
        {
            return new IGORR.Server.Logic.Blocker(map, new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
