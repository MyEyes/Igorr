...
{
    class SlimerTemplate:IGORR.Modules.ObjectTemplate
    {
        ...
        {
            return new IGORR.Server.Logic.AI.Slimer(map, "Slimer", new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 64, 64), objectID);
        }
