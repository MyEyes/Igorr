...
namespace DefaultModule
{
    class StaticLightTemplate : IGORR.Modules.ObjectTemplate
    {
        ...
        {
            return new IGORR.Server.Logic.DummyObject(10003, map, new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
        ...
        {
            return new IGORR.Client.Logic.StaticLight(map, null, new Microsoft.Xna.Framework.Rectangle(p.X, p.Y, 16, 16), objectID);
        }
