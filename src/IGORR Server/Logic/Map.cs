        ...
        public void SpawnItem(int id, BinaryReader reader)
        {
            if (_spawnPoints.ContainsKey(id))
            {
                ...
                switch (id)
                {
                    ...
                    case 22: newObject = new ScorePost(ScorePost.ScoreColor.Red, this, new Rectangle(p.X - 8, p.Y - tileSize * 3, tileSize + 8, tileSize * 4), ObjectManager.getID()); break;
                    case 23: newObject = new ScorePost(ScorePost.ScoreColor.Blue, this, new Rectangle(p.X - 8, p.Y - tileSize * 3, tileSize + 8, tileSize * 4), ObjectManager.getID()); break;
                    case 29: newObject = new ScorePost(ScorePost.ScoreColor.Neutral, this, new Rectangle(p.X - 8, p.Y - tileSize * 3, tileSize + 8, tileSize * 4), ObjectManager.getID()); break;
                    case 24: newObject = new MessageBoard(this, new Rectangle(p.X , p.Y , tileSize , tileSize), ObjectManager.getID()); break;
